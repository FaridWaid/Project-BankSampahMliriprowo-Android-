...
class DaftarPengumpulanSemuaAnggotaAdapter(private var list: ArrayList<PengumpulanAnggota>): RecyclerView.Adapter<DaftarPengumpulanSemuaAnggotaAdapter.DaftarPengumpulanViewHolder>() {
